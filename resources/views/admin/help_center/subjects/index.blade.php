...
@section('content')
    ...
    <!-- /.content-wrapper -->
    @include('admin.help_center.subjects.create-edit-modal')
@endsection
...
@push('js')
    ...
    <script>
        var table_data_url = "{{ route('admin.help_center.subjects.table_data') }}";
    </script>
    {{-- DatatTable --}}
    <script>
        /**
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '[data-toggle="modal"][data-target="#create-edit-modal"]', function(e) {
                ...
                if (is_create === 1) {
                    ...
                    $('#create-edit-modal .modal-title').text("{{ __('backend.subject_edit') }} : " + $(this)
